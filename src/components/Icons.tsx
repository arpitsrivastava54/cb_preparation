const icons = [
  ...
  {
    name: "halfStar",
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24">
      <defs>
...
type IconNameType ="menu"|"gift"|"tick"|"plus"| "right-arrow" | "greater-than" | "search" | "fullStar" | "halfStar" | "timer";

const Icons = ({ name }: { name: IconNameType }) => {
