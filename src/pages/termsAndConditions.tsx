...
const termsAndConditions = () => {
  return (
    <>
      ...
      <p>
        Welcome to <strong>KnowledgeGate Eduventure LLC</strong> (“Company”, “we”,
        “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <strong>www.knowledgegate.in</strong> (together or
        individually “Service”) operated by{" "}
        <strong>KnowledgeGate Eduventure LLC</strong>.
      </p>
      <p>
      ...
      <p>
        ...
        <strong>contact@knowledgegate.in</strong> so we can try to find a
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at contact@knowledgegate.in.
      </p>
      <p>
      ...
      <p>
        ...
        KnowledgeGate Eduventure LLC cancels it. You may cancel your Subscription
        renewal either through your online account management page or by
        contacting contact@knowledgegate.in customer support team.
      </p>
      <p>
        A valid payment method is required to process the payment for your
        subscription. You shall provide KnowledgeGate Eduventure LLC with accurate
        ...
        automatically authorize KnowledgeGate Eduventure LLC to charge all
        Subscription fees incurred through your account to any such payment
        instruments.
      </p>
      <p>
        Should automatic billing fail to occur for any reason, KnowledgeGate
        Eduventure LLC reserves the right to terminate your access to the Service
      ...
      <p>
        KnowledgeGate Eduventure LLC may, at its sole discretion, offer a
      ...
      <p>
        ...
        you will not be charged by KnowledgeGate Eduventure LLC until Free Trial
      ...
      <p>
        At any time and without notice, KnowledgeGate Eduventure LLC reserves the
      ...
      <p>
        KnowledgeGate Eduventure LLC, in its sole discretion and at any time, may
      ...
      <p>
        KnowledgeGate Eduventure LLC will provide you with a reasonable prior
      ...
      <p>
        We issue refunds for Contracts within <strong>0 days</strong> of the
      ...
      <p>
        KnowledgeGate Eduventure LLC has the right but not the obligation to
        monitor and edit all Content provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property of
        KnowledgeGate Eduventure LLC or used with permission. You may not
      ...
      <p>
        ...
        KnowledgeGate Eduventure LLC and its licensors. Service is protected by
        ...
        without the prior written consent of KnowledgeGate Eduventure LLC.
      </p>
      <p>
      ...
      <p>
        ...
        contact@knowledgegate.in, with the subject line: “Copyright Infringement”
      ...
      <p>
        You can contact our Copyright Agent via email at contact@knowledgegate.in.
      </p>
      <p>
        17. <strong>Error Reporting and Feedback</strong>
      </p>
      <p>
        You may provide us either directly at contact@knowledgegate.in or via
      ...
      <p>
        ...
        are not owned or controlled by KnowledgeGate Eduventure LLC.
      </p>
      <p>
        KnowledgeGate Eduventure LLC has no control over, and assumes no
      ...
      <p>
        ...
        email: <strong>contact@knowledgegate.in</strong>.<br />
      </p>
    </>
  )
}
