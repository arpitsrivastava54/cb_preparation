...
const privacy = () => {
  return (
    ...
    <p>
      Welcome to <strong> KnowledgeGate Eduventure LLP</strong>.
    </p>
    <p>
      <strong>KnowledgeGate Eduventure LLP</strong> (“us”, “we”, or “our”)
      operates{" "}
      <strong>
        <a href="http://www.knowledgegate.in">www.knowledgegate.in</a>
      </strong>{" "}
    ...
    <p>
      ...
      <a href="http://www.knowledgegate.in">www.knowledgegate.in</a> website
      operated by KnowledgeGate Eduventure LLP.
    </p>
    <p>
    ...
    <p>
      <strong>DATA PROCESSORS (OR SERVICE PROVIDERS)</strong> means any natural
    ...
    <p>
      <strong>DATA SUBJECT</strong> is any living individual who is the subject
      of Personal Data.
    </p>
    <p>
    ...
    <p>
      ...
      permission to do so (<strong>“Location Data”</strong>). We use this data
    ...
    <p>
      0.4. <strong>Advertising Cookies:</strong> Advertising Cookies are used to
    ...
    <p>
      KnowledgeGate Eduventure LLP uses the collected data for various purposes:
    </p>
    ...
    <p>
      KnowledgeGate Eduventure LLP will take all the steps reasonably necessary
    ...
    <p>
      ...
      <strong>contact@knowledgegate.in</strong>.
    </p>
    <p>
    ...
    <p>
      ...
      send your request(s) by email: <strong>contact@knowledgegate.in</strong>.
    </p>
    <p>
