  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      ...
      <form className="w-full max-w-sm">
        ...
        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full mb-4">Sign In</button>
        <p className="text-sm text-gray-600 mb-2"><a href="#" className="text-blue-500">Forgot your password?</a></p>
        <div className="mb-2 text-center">
          <p className="text-sm text-gray-600">Don't have an account? <Link to={"/signup"} className="text-blue-500" >Sign Up</Link></p>
          <div className="mt-2">
        ...
        <div className="mt-4">
          <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex items-center justify-center w-full mb-4">
            <img src={google} alt="Google" className="w-6 h-6 mr-2 bg-white" />
